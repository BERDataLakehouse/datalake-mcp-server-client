...
from ...models.database_structure_request import DatabaseStructureRequest
from ...models.database_structure_response import DatabaseStructureResponse
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = DatabaseStructureResponse.from_dict(response.json())
...
def sync(
    *,
    ...
    Returns:
        DatabaseStructureResponse | ErrorResponse
    """
